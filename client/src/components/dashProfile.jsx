...
export default function dashProfile() {
    ...
    const handleDeleteUser = async() => {
        ...
        try {
            ...
            !res.ok ? dispatch(deleteUserFailure(data.message)) : dispatch(deleteUserSuccess(data));
        } catch(error) {
        ...
        <Modal show={ showModal } onClose={() => setShowModal(false)} popup size='md'>
            ...
            <Modal.Body>
                <div className='text-center'>
                    ...
                    <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you want o delete your account?</h3>
